 ...
 * area coordinates).
 */
void macdrv_window_set_io_surface(WineWindow *window, IOSurfaceRef image, CGRect rect, CGRect dirty)
{
@autoreleasepool
{
 ...
 */
void macdrv_window_shape_changed(WineWindow *window, int has_shape)
{
@autoreleasepool
{
    OnMainThreadAsync(^{
